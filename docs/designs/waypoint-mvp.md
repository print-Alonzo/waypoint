...
> **Historical.** This is the original approved spec, preserved as written. Its file paths predate
> the 2026-07 source reorganization — `components/` is now grouped by route, `lib/` by domain, and
> tests live under `web/tests/`. For the current tree see
> [`web/README.md`](../../web/README.md) § Project layout.
