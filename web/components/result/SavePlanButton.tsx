    ...
    return (
      <span className="flex flex-wrap items-center gap-2">
        ...
        <input
          ...
          className="w-44 rounded-lg border border-[var(--color-border)] bg-white px-3 py-2.5 text-sm focus:outline-none focus:border-[var(--color-text)] focus:ring-1 focus:ring-[var(--color-text)]"
        />
        <button
          type="button"
